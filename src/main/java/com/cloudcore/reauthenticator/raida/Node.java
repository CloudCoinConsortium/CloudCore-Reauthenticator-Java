...
public class Node {
    ...
    public class MultiDetectResponse {
        public com.cloudcore.reauthenticator.raida.Response[] responses;
    }
    ...
    public CompletableFuture<MultiDetectResponse> MultiDetect(int[] nn, int[] sn, String[] an, String[] pan, int[] d, int timeout) {
        com.cloudcore.reauthenticator.raida.Response[] response = new com.cloudcore.reauthenticator.raida.Response[nn.length];
        for (int i = 0; i < nn.length; i++) {
            response[i] = new com.cloudcore.reauthenticator.raida.Response();
        }
